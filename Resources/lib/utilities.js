...
exports.unformatCurrency = function(n){
    var step1 = n.replace(",",'');
 ...
 */
function downloadOneFile(url, localFilepath, callBack_DownloadOneFileFinished) {
 ...
 * 
 */
exports.downloadMultiFile = function(downloadQueue, callBack_DownloadOneFileFinished, callBack_DownloadMultipleFileFinished) {
